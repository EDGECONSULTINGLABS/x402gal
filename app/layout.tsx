...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://x402gal.com/og-image.png",
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    title: "x402GAL — Every AI query has a water footprint",
    description: "Pay it back in real time. x402GAL settles water offsets on XRPL for every inference.",
    images: ["https://x402gal.com/og-image.png"],
  },
};
  ...
  return (
    <html lang="en" className={`${display.variable} ${body.variable} ${mono.variable}`}>
      <head>
        ...
        <meta property="og:image:secure_url" content="https://x402gal.com/og-image.png" />
        <meta property="og:image:type" content="image/png" />
        <meta property="og:image:width" content="1200" />
        <meta property="og:image:height" content="630" />
        <meta property="og:image:alt" content="x402GAL - Every AI query has a water footprint" />
        <meta name="twitter:image:src" content="https://x402gal.com/og-image.png" />
      </head>
